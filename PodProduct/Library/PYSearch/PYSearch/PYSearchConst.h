...
#define PYSEARCH_SEARCH_HISTORY_CACHE_Noti_PATH [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"PYSearchhistories_noti.plist"] // the path of search record cached

#define PYSEARCH_SEARCH_HISTORY_CACHE_DaiBan_PATH [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"PYSearchhistories_daiban.plist"] // the path of search record cached

#define PYSEARCH_SEARCH_HISTORY_CACHE_Process_PATH [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"PYSearchhistories_process.plist"] // the path of search record cached

#define PYSEARCH_SEARCH_HISTORY_CACHE_AddressSearch_PATH [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"PYSearchhistories_address.plist"] // the path of search record cached

#define PYSEARCH_SEARCH_HISTORY_CACHE_TaskFlow_PATH [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"PYSearchhistories_taskFlow.plist"] // the path of search record cached
