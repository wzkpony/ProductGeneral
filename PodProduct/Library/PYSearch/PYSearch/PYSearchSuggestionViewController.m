...
@interface PYSearchSuggestionViewController ()<DZNEmptyDataSetSource>
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView{
    NSMutableAttributedString * aAttributedString = [[NSMutableAttributedString alloc] initWithString:@"暂无相关内容"];
    //富文本样式
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return cell;
//    ContractPeopleCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
//    if (!cell) {
//        cell = [[ContractPeopleCell alloc]initWithStyle:0 reuseIdentifier:cellID];
//    }
//    cell.para = @{@"icon":@"123",@"name":@"刘能",@"post":@"设计师"};
