...
//    self.oKButtonTitleColorNormal   = kThemeColor;
//    self.oKButtonTitleColorDisabled = UIColorFromRGB(0x6A6A6A);
    if (iOS7Later) {
...
- (void)configDefaultSetting {
    ...
    self.naviTitleFont = PFMFONT(18);
    self.barItemTextFont = [UIFont systemFontOfSize:15];
    self.barItemTextColor = UIColorFromRGB(0x38CCB3);
