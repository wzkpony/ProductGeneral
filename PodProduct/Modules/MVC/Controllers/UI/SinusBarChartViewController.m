...
- (void)updateChartData
{
    ...
    [self setDataCount:(numberOne*3+1)];
}
...
- (void)setDataCount:(int)count
{
    ...
    {
        CGFloat f = sin(M_PI * (i % numberOne) / numberOne);
        CGFloat y = 0.0;
        switch (numberSin) {
            case 1:
                {
        ...
        [entries addObject:[[BarChartDataEntry alloc] initWithX:(double)i y:y]];
    }
